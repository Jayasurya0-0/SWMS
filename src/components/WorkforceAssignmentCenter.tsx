...
export const WorkforceAssignmentCenter: React.FC = () => {
  ...
  const presentEmployees = useMemo(() => {
    ...
    return employees.filter(emp => {
      ...
      // Only include Sewing and Floater departments for active operational mapping
      return dept === 'sewing' || dept === 'floater' || emp.lineNumber === 99 || emp.productionWorkforceEligible;
    });
